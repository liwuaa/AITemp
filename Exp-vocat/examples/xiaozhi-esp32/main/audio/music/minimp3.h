...
/* ESP32: mp3dec_scratch_t is ~16-20KB — never put it on FreeRTOS task stack. */
static mp3dec_scratch_t *mp3d_get_scratch(void)
{
    static mp3dec_scratch_t *s;
    if (!s)
    {
        s = (mp3dec_scratch_t *)malloc(sizeof(mp3dec_scratch_t));
    }
    return s;
}
